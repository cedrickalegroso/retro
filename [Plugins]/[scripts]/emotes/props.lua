...
attachPropList = {
	...
	--- FOOD SHIT ---
	--[[
    if pItemId == "hamburger" or pItemId == "heartstopper" or pItemId == "bleederburger" then
        TriggerEvent("attachItem", "hamburger")
    elseif pItemId == "sandwich" then
        TriggerEvent("attachItem", "sandwich")
    elseif pItemId == "donut" then
        TriggerEvent("attachItem", "donut")
    elseif pItemId == "water" or pItemId == "cola" then
        TriggerEvent("attachItem", pItemId)
	end
