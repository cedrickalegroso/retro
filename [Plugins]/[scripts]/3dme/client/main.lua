            ...
            if NetworkIsPlayerActive(p) then
                ...
                if DoesEntityExist(ped) then
                    ...
                    if not ons then
                        x = (x*100)
                        y = (y*100)
                        str = str.."<p style=\"left: "..x.."%;top: "..y.."%;-webkit-transform: translate(-50%, 0%);max-width: 100%;position: fixed;text-align: center;color: #fc0008;background-color: #000000AA;border-radius:3px;\"><b>⠀"..b.message.."⠀</b></p>"
                    end
                end
            end
        end
            ...
            if NetworkIsPlayerActive(p) then
                ...
                if DoesEntityExist(ped) then
                    ...
                    if not ons then
                        x = (x*100)
                        y = (y*100)
                        str = str.."<p style=\"left: "..x.."%;top: "..y.."%;-webkit-transform: translate(-50%, 0%);max-width: 100%;position: fixed;text-align: center;color: #0759e8;background-color: #000000AA;border-radius:3px;\"><b>⠀"..b.message.."⠀</b></p>"
                    end
                end
            end
        end
