...
MFF.MinPoliceOnline = 4

MFF.InteractKey = "E"
MFF.ResetTimer = 120 -- minutes?
MFF.InteractTimer = 25

MFF.LoadDist = 10000000.0
MFF.ActionDist = 1.0
...
MFF.TextAddons = {
  ["LockpickDoor"] = "Lockpick",
  ["LootID"] = "Search",
  ["OpenVault"] = "Request access",
  ["LootVault"] = "Cut open the lock",
}
...
Config = {}
Config.MinMoney = 4800
Config.MaxMoney = 5500