Locales['en'] = {
  ...
  ['gave_item'] = 'you gave ~y~%sx~s~ ~b~%s~s~',
  ['received_item'] = 'you received ~y~%sx~s~ ~b~%s~s~ ',
  ['gave_weapon'] = 'you gave ~y~1x~s~ ~b~%s~s~',
  ['gave_weapon_ammo'] = 'you gave ~y~1x~s~ ~b~%s~s~ with ~o~%sx~s~ bullets',
  ['gave_weapon_hasalready'] = 'the person already have an ~y~%s~s~',
  ['received_weapon'] = 'you received ~y~1x~s~ ~b~%s~s~',
  ['received_weapon_ammo'] = 'you received ~y~1x~s~ ~b~%s~s~ with ~o~%sx~s~ bullets',
  ['received_weapon_hasalready'] = 'someone attempted to give you an ~y~%s~s~, but you already have one.',
  ['gave_ammo'] = 'you gave ~o~%sx~s~ bullets.',
  ['received_ammo'] = 'you received ~o~%sx~s~ bullets.',
  ['gave_money'] = 'you gave ~g~$%s~s~',
  ['received_money'] = 'you received ~g~$%s~s~',
  ['gave_account_money'] = 'you gave ~g~$%s~s~ (%s)',
  ['received_account_money'] = 'you received ~g~$%s~s~ (%s)',
  ['amount_invalid'] = 'invalid amount',
  ['players_nearby'] = 'no players nearby',
  ['ex_inv_lim'] = 'action not possible, exceeding inventory limit',
