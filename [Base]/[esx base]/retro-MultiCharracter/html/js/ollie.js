...
$('.create-button').click(function() {
    ...
    $.post("http://retro-MultiCharacter/CharacterChosen", JSON.stringify({
...
$("#deletechar").click(function() {
    ...
    if (chosenCharacterId > 0) {
        $.post("http://retro-MultiCharacter/DeleteCharacter", JSON.stringify({
            charid: chosenCharacterId,
        }));
    }
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://retro-MultiCharacter/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
