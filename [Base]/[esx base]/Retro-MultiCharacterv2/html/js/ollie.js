...
$('.create-button').click(function() {
    ...
    $.post("http://Retro-MultiCharacterv2/CharacterChosen", JSON.stringify({
...
$("#deletechar").click(function() {
    ...
    if (chosenCharacterId > 0) {
        $.post("http://Retro-MultiCharacterv2/DeleteCharacter", JSON.stringify({
            charid: chosenCharacterId,
        }));
    }
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://Retro-MultiCharacterv2/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
