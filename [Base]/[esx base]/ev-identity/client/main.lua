...
RegisterNUICallback('register', function(data, cb)
	...
	if reason == "" then
		...
		SetEntityCoords(GetPlayerPed(-1), 100.76865386963,-1713.3923339844,30.112564086914)
		DoScreenFadeIn(1000)
		Wait(1000)
		...
		TriggerEvent('chat:addMessage', {
			template = '<div style="padding: 0.6vw; padding-left: 0.8vw; background-color: rgba(30, 30, 255, 0.9); border-radius: 6px;"><span style="width: 100%; font-weight: bold;">[RETRO CITY]: </span>Welcome To Retro City Season 2!, Make sure to join the [discord]: https://discord.retrocity.xyz also make sure to read all the rules.</div>',
			args = {}
		})  
	else
		TriggerEvent('notification',reason,2)
	end
end)
