...
$('.create-button').click(function () {
    ...
    $.post("http://ev-MultiCharacter/CharacterChosen", JSON.stringify({
...
$("#deletechar").click(function () {
	...
	if (chosenCharacterId > 0) {
		$.post("http://ev-MultiCharacter/DeleteCharacter", JSON.stringify({
			charid: chosenCharacterId,
		}));
    }
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://ev-MultiCharacter/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
