	...
	["Dark PawnShop"] = {
        ...
        Locations = {
            Store = {
                ...
                vector3(2224.7211914062,5604.8984375,54.922561645508),
    ...
    ["Electronic Shop"] = {
        ...
        Locations = {
            Store = {
                ...
                vector3(-243.24603271484,6209.12109375,31.939060211182)
            },
            Boss = {
...
Config.StashJ1 = {
    ...
    --    coords = vector3(441.89743041992,-984.34106445312,30.689506530762),'
        coords = vector3(-439.85250854492,5989.1987304688,31.716190338135),
        useText = true,
        size = vector3(1.0, 1.0, 1.0),
        job = "police",
        mingrade = 0,
    ...
    ["Groove"] = {
     ...
     coords = vector3(1453.5931396484,3549.0993652344,37.900466918945),
        useText = true,
        size = vector3(1.0, 1.0, 1.0),
        job = "groove",
        mingrade = 0,
