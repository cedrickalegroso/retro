ESX.RegisterServerCallback('ev-inventory:UseItemFromSlot', function(source, cb, slot)
...
ESX.RegisterServerCallback('ev-inventory:GetItemsInSlotsDisplay', function(source, cb)
    local player = ESX.GetPlayerFromId(source)
    InvType['player'].getInventory(player.identifier, function(inventory)
        local slotItems = {}
        for i = 1, 5, 1 do
...
ESX.RegisterServerCallback('ev-inventory:getPlayerIdFromSteam', function(source, cb, steam)
