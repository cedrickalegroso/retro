...
ESX.RegisterServerCallback('ev-inventory:getPlayerInventory', function(source, cb)
...
function ensurePlayerInventory(player)
    ...
    loadInventory(player.identifier, 'player', function()
        applyToInventory(player.identifier, 'player', function(inventory)
            ...
            TriggerClientEvent('ev-inventory:refreshInventory', player.source)
        end)
    end)
end

RegisterServerEvent('ev-inventory:notifyImpendingRemoval')
AddEventHandler('ev-inventory:notifyImpendingRemoval', function(item, count, playerSource)
...
RegisterServerEvent('ev-inventory:notifyImpendingAddition')
AddEventHandler('ev-inventory:notifyImpendingAddition', function(item, count, playerSource)
    local _source = playerSource or source
...
AddEventHandler('esx:onRemoveInventoryItem', function(source, item, count)
    ...
    TriggerClientEvent('ev-inventory:showItemUse', source, {
