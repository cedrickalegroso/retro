...
Config.ExtraVisionShops = {
    ...
    ['Retro Shops'] = {
        coords = {
            ...
            vector3(1166.024, 2708.930, 38.177),
            vector3(1392.562, 3604.684, 35.0),
            vector3(-2968.2114257812,391.41360473633,15.043315887451), 
        },
        items = {
    ...
    ['Black Market'] = {
        ...
        items = {
            { name = "WEAPON_COMPACTRIFLE", price = 50000, count = 1, grade = 0 },
            { name = "WEAPON_MINISMG", price = 12500, count = 1, grade = 0 },
            { name = "WEAPON_ASSAULTRIFLE", price = 50000, count = 1, grade = 0 },
            { name = "WEAPON_PUMPSHOTGUN", price = 7500, count = 1, grade = 0 },
            { name = "WEAPON_SAWNOFFSHOTGUN", price = 7500, count = 1, grade = 0 },
            { name = "WEAPON_MOLOTOV", price = 2500, count = 1, grade = 0 },
            { name = "WEAPON_ASSAULTSMG", price = 15000, count = 1, grade = 0 },
    ...
    ['Retro Weapon Shop'] = {
        coords = {
			...
			vector3(-330.7, 6083.97, 32.45),
			vector3(252.08, -50.26, 70.94),
			vector3(22.39, -1106.79, 30.8),
			vector3(2567.7, 294.75, 109.73),
			vector3(-1117.49, 2698.6, 19.55),
			vector3(842.41, -1033.4, 29.19)
        },
        items = {
