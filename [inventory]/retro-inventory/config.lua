...
Config.ExtraVisionShops = {
    ...
    ['EV Starbucks'] = {
        ...
        items = {
            { name = "sandwhich", price = 0, count = 1 },
    ...
    ['Black Market'] = {
        coords = {
            vector3(1395.2141113281,1152.8054199219,114.37124633789)
        },
        items = {
    ...
    ['PB'] = {
     ...
     ['Police Armory'] = {
        ...
        items = {
            ...
            { name = "WEAPON_STUNGUN", price = 0, count = 1, grade = 0 },
            { name = "WEAPON_NIGHTSTICK", price = 0, count = 1, grade = 0 },
            { name = "WEAPON_ADVANCEDRIFLE", price = 0, count = 1, grade = 5 },
            { name = "WEAPON_HEAVYSNIPER", price = 0, count = 1, grade = 6 },
            { name = "WEAPON_COMBATPISTOL", price = 0, count = 1, grade = 0 },
            { name = "WEAPON_FLARE", price = 0, count = 1, grade = 0 },
...
Config.Stash = {
    ...
    ['Police Stash'] = {
        coords = vector3(451.48257446289,-979.80480957031,30.689332962036),
        size = vector3(1.0, 1.0, 1.0),
        job = 'police',
        markerType = 2,
        markerColour = { r = 255, g = 255, b = 255 },
        msg = 'Press ~r~[E]~h~ To Open Police Stock',
        show3D = true
    },

    ['Ambulance Stash'] = {
        coords = vector3(-452.12454223633,-324.62817382812,34.910820007324),
        size = vector3(1.0, 1.0, 1.0),
        job = 'ambulance',
        markerType = 2,
        markerColour = { r = 255, g = 255, b = 255 },
