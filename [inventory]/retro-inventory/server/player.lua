...
ESX.RegisterServerCallback('retro-inventory:getPlayerInventory', function(source, cb)
...
function ensurePlayerInventory(player)
    ...
    loadInventory(player.identifier, 'player', function()
        applyToInventory(player.identifier, 'player', function(inventory)
            ...
            TriggerClientEvent('retro-inventory:refreshInventory', player.source)
        end)
    end)
end

RegisterServerEvent('retro-inventory:notifyImpendingRemoval')
AddEventHandler('retro-inventory:notifyImpendingRemoval', function(item, count, playerSource)
...
RegisterServerEvent('retro-inventory:notifyImpendingAddition')
AddEventHandler('retro-inventory:notifyImpendingAddition', function(item, count, playerSource)
    local _source = playerSource or source
...
AddEventHandler('esx:onRemoveInventoryItem', function(source, item, count)
    ...
    TriggerClientEvent('retro-inventory:showItemUse', source, {
