...
function InitiateMenus(isMotorcycle, vehicleHealth)
    ...
    if vehicleHealth < 1000.0 then
        ...
        TriggerServerEvent("mechanic:updateRepairCost", repairCost)
        createMenu("repairMenu", "Mechanic Menu", "Repair Vehicle")
        populateMenu("repairMenu", -1, "Repair", "Free")
        finishPopulatingMenu("repairMenu")
    end

    --#[Main Menu]#--
    createMenu("mainMenu", "Mechanic Menus", "Choose a Category")
    ...
    populateMenu("mainMenu", 25, "Vehicle Extras", "none")
    ...
    if state then
        ...
        elseif isMenuActive("NeonsSideMenu") then
            ...
            if currentMenu == "mainMenu" or currentMenu == "repairMenu" then
                ExitBennys()
            elseif currentMenu == "ResprayMenu" or currentMenu == "WindowTintMenu" or currentMenu == "WheelsMenu" or currentMenu == "NeonsMenu" or currentMenu == "XenonsMenu" or currentMenu == "OldLiveryMenu" or currentMenu == "VehicleExtrasMenu" then
                toggleMenu(false, currentMenu)
