...
function SendDistressSignal()
	...
	TriggerEvent('notification', 'Help signal has been sent to available ems!', 2)
...
function StartDeathTimer()
	...
	Citizen.CreateThread(function()
		...
		while earlySpawnTimer > 0 and isDead do
			Citizen.Wait(0)
			drawTxt(0.89, 1.44, 1.0,1.0,0.6, "Respawn: ~r~" .. math.ceil(earlySpawnTimer) .. "~w~ seconds remaining", 255, 255, 255, 255)
		end
		...
		while isDead do
			...
			drawTxt(0.89, 1.44, 1.0,1.0,0.6, "~w~HOLD ~r~E ~w~(" .. math.ceil(EHeld/100) .. ") ~w~TO ~r~RESPAWN ~w~", 255, 255, 255, 255)
		end
