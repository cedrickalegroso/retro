...
Locales['en'] = {
  ...
  ['place_objects'] = 'spawner',
  -- Phone
  ['alert_ambulance'] = 'alert Ambulance',
  -- Death
  ['respawn_available_in'] = ' Respawn ~r~%s~w~ seconds remaining',
  ['respawn_bleedout_in'] = "~w~HOLD ~r~E~w~ TO ~r~RESPAWN ~w~",
  ['respawn_bleedout_prompt'] = 'hold [~o~E~s~] to respawn',
  ['respawn_bleedout_fine'] = 'hold [~o~E~s~] to respawn for ~g~$%s~s~',
  ['respawn_bleedout_fine_msg'] = 'you paid ~r~$%s~s~ to respawn.',
  ['distress_send'] = 'press [~o~G~s~] to send distress signal',
  ...
  ['not_enough_medkit'] = 'You do not have ~o~medkit~s~.',
  ['not_enough_bandage'] = 'You do not have ~o~bandage~s~.',
