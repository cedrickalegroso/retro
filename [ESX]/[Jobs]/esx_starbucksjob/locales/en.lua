Locales['en'] = {
  ...
  ['starbucks_wear'] = 'starbucks Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~starbucks~s~',
  -- Vehicle interaction
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['starbucks_stock'] = 'starbucks Stock',
  -- Misc
  ...
  -- Notifications
  ['alert_starbucks'] = 'starbucks alert',
  ['phone_starbucks'] = 'starbucks',
}
