...
Config.Vehicles = {
	{ name = 'pol3', label = "pol3", grade = 1},
	{ name = 'pol9', label = "pol9", grade = 4},
	{ name = 'pol6', label = "pol6", grade = 1},
    { name = 'pol8', label = "pol8", grade = 1},
    { name = 'psp_bmwgs', label = "Yasam Bike", grade= 2},
	{ name = 'pol10', label = "pol10", grade = 5},
    { name = 'police2', label = "police2", grade = 6},
    { name = 'ucballer', label = "Police Range Rover", grade = 0},
}