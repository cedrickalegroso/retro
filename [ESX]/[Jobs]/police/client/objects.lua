...
AddEventHandler('police:client:removeObject', function(objectId)
    ...
    TriggerServerEvent("police:server:setObjects",ObjectList)
end)
...
CreateThread(function()
    Wait(100)
    TriggerServerEvent("police:server:wantObjects",ObjectList)
end)


RegisterNetEvent("police:client:setObjects")
AddEventHandler("police:client:setObjects", function(table)
    ObjectList = table
end)