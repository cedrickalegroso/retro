                    ...
                    if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 2) then
                        if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 1.0) then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                TriggerEvent('inventory:stash', 'Police Evidence ' .. k)
                                TriggerServerEvent('police:logs', GetPlayerName(PlayerId()) .. "(" .. GetPlayerServerId(PlayerId()) .. ") " .. "Open Police Evidence Box " .. k)
                            end
                    ...
                    if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 2) then
                        if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 1.0) then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                ...
                                TriggerServerEvent('police:logs', GetPlayerName(PlayerId()) .. "(" .. GetPlayerServerId(PlayerId()) .. ") " .. "Open Police Garbage can")
                    ...
                    if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 4.5) then
                        if true then
                            if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 1.5) then
                                ...
                                if IsControlJustReleased(0, Keys["E"]) then
                                    SecurityCameras()
                                    TriggerServerEvent('police:logs', GetPlayerName(PlayerId()) .. "(" .. GetPlayerServerId(PlayerId()) .. ") " .. "Open Police Cameras")
                                end
                    ...
                    if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 4.5) and ESX.PlayerData.job.grade_name == 'boss' then
                         if (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 1.5) then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                ...
                                TriggerServerEvent('police:logs', GetPlayerName(PlayerId()) .. "(" .. GetPlayerServerId(PlayerId()) .. ") " .. "Open Boss Menu")
                            end
                        elseif (GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 2.5) then
...
function SecurityCameras()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'security_cameras', {
      ...
      elements = elements
        ...
        TriggerServerEvent('police:logs', GetPlayerName(PlayerId()) .. "(" .. GetPlayerServerId(PlayerId()) .. ") " .. "Opened Camera System\n Camera Number: " ..data.current.camera)
