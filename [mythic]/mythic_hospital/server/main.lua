local beds = {
    { x = 319.29, y = -581.13, z = 43.11, h = -20.0, taken = false, model = 1631638868 },
    { x = 317.9, y = -585.32, z = 43.11, h = -20.0, taken = false, model = -1091386327 },
    { x = 322.93, y = -586.92, z = 43.11, h = -20.0, taken = false, model = 1631638868 },
    { x = 307.93, y = -581.65, z = 43.11, h = -20.0, taken = false, model = -1091386327 },
    { x = 309.08, y = -577.63, z = 43.11, h = 80.0, taken = false, model = -1091386327 },
    { x = 313.72, y = -579.09, z = 43.01, h = 80.0, taken = false, model = -1091386327 },
    { x = 323.64, y = -575.16, z = 43.11, h = -20.0, taken = false, model = -1091386327 },
    { x = 326.97, y = -576.229, z = 43.11, h = -20.0, taken = false, model = -1091386327 },
