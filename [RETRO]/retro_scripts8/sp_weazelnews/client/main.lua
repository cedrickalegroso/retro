  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:openBosRETROsMenu', 'weazelnews', function(data, menu)
          menu.close()
        end)
      end
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_biRETROlling:sendBill1', GetPlayerServerId(player), 'society_weazelnews', _U('billing'), amount)
        end
          ...
          if IsControlJustReleased(0, 38) and PlayerData.job ~= nil and PlayerData.job.name == 'weazelnews' then
            ...
            if CurrentAction == 'delete_vehicle' then
              ...
              if Config.EnableSocietyOwnedVehicles then
                ...
                TriggerServerEvent('esx_society:putVehicleRETROInGarage', 'weazelnews', vehicleProps)
