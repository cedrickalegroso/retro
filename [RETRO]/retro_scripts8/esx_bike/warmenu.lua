...
function WarMenu.CreateMenu(id, title)
    ...
    menus[id].titleColor = { r = 0, g = 255, b = 0, a = 255 }
    menus[id].titleBackgroundColor = { r = 50, g = 50, b = 50, a = 255 }

    menus[id].menuTextColor = { r = 100, g = 255, b = 0, a = 255 }
    menus[id].menuSubTextColor = { r = 0, g = 100, b = 255, a = 255 }
