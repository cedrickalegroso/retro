...
Citizen.CreateThread(
    function()
        if not ConfigBike.EnableBlips then
            return
        end
...
local circleA =
    CircleZone:Create(
    vector3(411.32260131836, -974.80645751953, 29.424772262573),
    0.5,
    {
        name = 'a',
        data = {job = 'police'}
...
local circleB =
    CircleZone:Create(
    vector3(289.47619628906,-561.5869140625,43.248123168945),
    0.5,
    {
        name = 'b',
        data = {job = 'ambulance'}
...
local circleC =
    CircleZone:Create(
    vector3(-185.6703338623,-1308.9442138672,31.296081542969),
    0.5,
    {
        name = 'c',
        data = {job = 'groove'}
...
Citizen.CreateThread(function()
    ...
    if ConfigBike.EnablePrice == true then
        table.insert(
            elements,
            {
                label = 'Bike - <span style="color:green;">TriBike</span> <span style="color:red;">1000</span>',
                value = 'bike'
            }
        )
        table.insert(
            elements,
            {
                label = 'Bike - <span style="color:green;">Scorcher</span> <span style="color:red;">950</span>',
                value = 'bike2'
            }
        )
        table.insert(
            elements,
            {
                label = 'Bike - <span style="color:green;">Cruiser</span> <span style="color:red;">750</span>',
                value = 'bike3'
            }
        )
        table.insert(
            elements,
            {
                label = 'Bike - <span style="color:green;">BMX</span> <span style="color:red;">450</span>',
                value = 'bike4'
            }
        )
    end
