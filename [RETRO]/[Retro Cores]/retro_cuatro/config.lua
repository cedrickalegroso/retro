...
Config.CuatroStations = {

	LSPD = {

		Blip = {
			Coords  = vector3(-1888.5909423828,2049.8063964844,140.98368835449),
			Sprite  = 181,
			Display = 4,
			Scale   = 1.0,
			Colour  = 29
		...
		Armories = {
			vector3(-1866.5858154297,2065.3559570312,135.43450927734)
		},

		Vehicles = {
			{
				Spawner = vector3(-1877.5522460938,2061.978515625,145.57382202148),
				InsideShop = vector3(-1907.0874023438,2020.9497070312,140.79257202148),
				SpawnPoints = {
		...
		Helicopters = {
			{
				Spawner = vector3(-1902.4119873047,2097.2839355469,142.27651977539),
				InsideShop = vector3(-1878.6215820312,3003.4211425781,32.810466766357),
				SpawnPoints = {
					{coords = vector3(-1907.5444335938,2100.6118164062,142.27651977539), heading = 92.6, radius = 10.0}
				}
			}
		},

		BossActions = {
			vector3(-1876.1448974609,2060.7250976562,145.57359313965)
		}
...
Config.AuthorizedVehicles = {
	...
	tyro = {
		...
		{ model = 'bati2', label = 'Bati 800', price = 400 },
