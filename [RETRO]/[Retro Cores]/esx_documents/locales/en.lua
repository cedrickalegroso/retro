...
Config.Documents['en'] = {
      ["public"] = {
        ...
        {
          headerTitle = "CITIZENSHIP REQUEST",
          headerSubtitle = "Official Retro City Citizenship request.",
          elements = {
            { label = "DATE OF ARRIVAL", type = "input", value = "", can_be_emtpy = false },
            { label = "TESTIMONY CONTENT", type = "textarea", value = "Tell us a story about you. ", can_be_emtpy = false },
          }
        },
        {
      ...
      ["police"] = {
        {
          headerTitle = "POLICE CLEARANCE",
          headerSubtitle = "Official RCPD Clearance.",
          elements = {
        ...
        {
          headerTitle = "VEHICLE SEARCH WARRANT",
          headerSubtitle = "Special warrant provided by the police to let officers search suspicious vehicles.",
          elements = {
            { label = "HOLDER FIRSTNAME", type = "input", value = "", can_be_emtpy = false },
            { label = "HOLDER LASTNAME", type = "input", value = "", can_be_emtpy = false },
            { label = "VALID UNTIL", type = "input", value = "", can_be_empty = false },
            { label = "INFORMATION", type = "textarea", value = "THE AFOREMENTIONED CITIZEN IS ALLOWED AND GRANTED A VEHICLE SEARCH WARRANT WHICH WILL BE VALID UNTIL THE AFOREMENTIONED EXPIRATION DATE.", can_be_emtpy = false },
          }
        },
        {
      ...
      ["ambulance"] = {
        ...
        {
          headerTitle = "MEDICAL CLEARANCE",
          headerSubtitle = "Official RCEMS Medical.",
          elements = {
            { label = "INSURED FIRSTNAME", type = "input", value = "", can_be_emtpy = false },
            { label = "INSURED LASTNAME", type = "input", value = "", can_be_emtpy = false },
            { label = "VALID UNTIL", type = "input", value = "", can_be_empty = false },
            { label = "MEDICAL NOTES", type = "textarea", value = "THIS IS TO CERTIFY THAT THE AFOREMENTIONED CITIZEN HAS UNDERGONE A THROROUGH MEDICAL EXAMNINATION CONDUCTED BY A RETRO CITY EMS STAFF. HE/SHE WAS DETERMINED MENTALLY AND PHYCICALLY HEALTHY. THIS REPORT IS VALID UNTIL THE AFOREMENTIONED EXPIRATION DATE.", can_be_emtpy = false },
          }
        },
      ...
      ["governemnt"] = {
        {
          headerTitle = "RETRO OFFICIAL CITIZENSHIP",
          headerSubtitle = "Retro City offical Citizenship.",
          elements = {
            { label = "CITIZEN FIRSTNAME", type = "input", value = "", can_be_emtpy = false },
            { label = "CITIZEN LASTNAME", type = "input", value = "", can_be_emtpy = false },
            { label = "VALID UNTIL", type = "input", value = "", can_be_empty = false },
            { label = "INFORMATION", type = "textarea", value = "THIS DOCUMENT IS PROOF OF OFFICIAL CITZENSHIP OF THE AFOREMENTIONED CITIZEN. LEGAL SERVICES ARE VALID UNTIL THE AFOREMENTIONED EXPIRATION DATE.", can_be_emtpy = false },
          }
        },
