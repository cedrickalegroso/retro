...
Config.AuthorizedVehicles = {
	{model = 'surfer2', label = 'Jeepney'},
	{model = 'jitney', label = 'Moto Jeepney'}
}

Config.Zones = {

	VehicleSpawner = { -- 124.80502319336,6628.6225585938,31.907428741455
		Pos   = {x = 124.80502319336, y = 6628.6225585938, z = 31.907428741455},
	...
	VehicleSpawnPoint = { -- ,,
		Pos     = {x = 126.16581726074, y = 6623.134765625, z = 31.808620452881},
	...
	VehicleDeleter = { -- ,,
		Pos   = {x = 121.98049163818, y = 6619.2319335938, z = 30.835557937622},
	...
	TaxiActions = { -- ,,
		Pos   = {x = 99.386688232422, y = 6620.2221679688, z = 32.435321807861},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 20, Rotate = true
	},
