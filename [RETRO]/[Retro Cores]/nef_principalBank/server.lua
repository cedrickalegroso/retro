...
RegisterServerEvent('nef_anncprin:gg')
AddEventHandler('nef_anncprin:gg', function()
...
local message = name..'started a Principal robbery'
local color = 56108
...
TriggerClientEvent('chat:addMessage', -1, {
    template = '<div class="chat-message system"><b> 👮 RCPD : </b> ^1Ongoing Principal Bank Robbery ^3 EMS AND MECHANIC STANDBY!  </div>',
    args = { fal, msg }
})
