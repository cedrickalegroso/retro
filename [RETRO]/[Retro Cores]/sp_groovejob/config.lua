...
grooveActions = {
	...
	,,
	]]-- ,,32.435317993164  -197.90061950684,-1341.3924560547,34.899444580078
	grooveActions = {
		Pos   = { x =-197.90061950684, y = -1341.3924560547, z = 34.899444580078 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 0, g = 204, b = 0 },
		Type  = 22,
	},
	...
	Craft = {
		Pos   = { x = -198.14421081543, y = -1315.375, z = 31.089263916016 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 0, g = 204, b = 0 },
		Type  = 21,
	},
