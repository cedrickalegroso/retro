...
RegisterNetEvent('retro_mechanic:updateBlip')
AddEventHandler('retro_mechanic:updateBlip', function()

	print('show blips on all mech!')
		...
		if data.current.value == 'vehicle_list' then
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				local elements = {					
					...
					{label = 'Small Towtruck', value = 'towtruck'},										
