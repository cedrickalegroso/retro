...
RegisterNetEvent('retro_scripts:newlife2')
AddEventHandler('retro_scripts:newlife2', function(ttPID)
	...
	TriggerEvent('notification', 'You were dead and was sent to Purgatory', 1)
	ESX.TriggerServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function()

		local playerpos = GetEntityCoords( GetPlayerPed(ttPID) )
		...
		TriggerEvent("mythic_progbar:client:progress", {
			...
			if not status then
				TriggerEvent('notification', 'You just landed at Retro City', 1)
				RespawnPed(PlayerPedId(pP), playerpos, 150)
				TriggerServerEvent('retro_scripts:clearplayerloadoutitems', ttPID)
				SetEntityCoords(PlayerPedId(ttPID), -496.83135986328,-336.2590637207,34.501667022705, true, true, true, false)
				Citizen.Wait(10)
				StopScreenEffect('DeathFailOut')
				DoScreenFadeIn(800)
			end
...
AddEventHandler('retro_scripts:newlife', function(ttPID)
	...
	print('newlife '..ttPID)
	SetEntityCoords(GetPlayerFromId(pP), 251.18321228027, -1348.2706298828, 24.537813186646, true, true, true, false)
...
--RespawnPed(PlayerPedId(), pos, ConfigAmbu.RespawnPoint.heading)
   ...
   -- RespawnPed(PlayerPedId(), playerpos, 150)
...
SetEntityCoords(PlayerPedId(ttPID), 235.32685852051,-1118.2874755859,29.294023513794, true, true, true, false)
