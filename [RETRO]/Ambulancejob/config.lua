...
Config.RespawnPoint = { coords = vector3(-497.27377319336, -336.62002563477, 34.501686096191), heading = 162.79 }
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(-436.15930175781, -326.03063964844, 34.910762786865),
			sprite = 61,
			scale  = 1.2,
			color  = 2
		},
		...
		AmbulanceActions = {
			vector3(-447.40307617188,-322.81497192383,34.91081237793)
		},

		Pharmacies = {
			vector3(-452.27099609375,-324.75592041016,34.91081237793)
		},
