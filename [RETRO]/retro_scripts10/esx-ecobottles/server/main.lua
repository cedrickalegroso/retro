...
AddEventHandler("esx-ecobottles:sellBottles", function()
    ...
    if currentBottles > 0 then
        ...
        local randomMoney = math.random((ConfigBottles.BottleReward[200] or 200), (ConfigBottles.BottleReward[200] or 200))
...
AddEventHandler("esx-ecobottles:retrieveBottle", function()
    ...
    local randomBottle = math.random((ConfigBottles.BottleRecieve[1] or 1), (ConfigBottles.BottleRecieve[2] or 6))
