...
AddEventHandler('esx_doorlock:updateState', function(doorIndex, state)
	...
	if xPlayer and type(doorIndex) == 'number' and type(state) == 'boolean' and Config.DoorListLOCK[doorIndex] and isAuthorized(xPlayer.job.name, Config.DoorListLOCK[doorIndex]) then
