...
local insideMoneywash = false

--Name: Moneywash | 2021-03-23T10:34:03Z
local Moneywash = CircleZone:Create(vector3(-1139.3768310547,4965.2333984375,222.24349975586), 1.75, {
    name="Moneywash",
    useZ=false,
  -- debugPoly=true
})
...
Moneywash:onPointInOut(PolyZone.getPlayerPosition, function(isPointInside, point)
    insideMoneywash = isPointInside
    if isPointInside then
        OpenWashedMenu()
        insideMoneywash = true
    else
		insideMoneywash = false
    end
end)
...
Citizen.CreateThread(function()
    ...
    insideMoneywash = Moneywash:isPointInside(coord)
    Citizen.Wait(500)

   

    CreateBlipCircle(vector3(-1139.3768310547,4965.2333984375,222.24349975586), 'Money Wash', 100.0, 100.0, 225)
...
Citizen.CreateThread(function()
	while true do
		...
		for k,zoneID in pairs(Config.ZonesMoneywash) do
