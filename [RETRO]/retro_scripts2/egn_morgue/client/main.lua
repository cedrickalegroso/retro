ESX = nil
local IsMorgued, unmorgued, MorgueTime, morgueTimer, GraveyardLocation = false, false, 0, 0, ConfigMorgue.GraveyardLocation 

ConfigMorgue = {}
ConfigMorgue.GraveyardBlip = {x = -1762.744, y = -262.012, z = 48.288}
ConfigMorgue.GraveyardLocation = {x = -1762.744, y = -262.012, z = 47.288}
ConfigMorgue.BornLocation = {x = 298.1268, y = -584.515, z = 43.26084}
ConfigMorgue.Locale = 'en'
...
AddEventHandler('esx_morgue:morgue', function(morgueTimer)
	...
	Citizen.CreateThread(function()
		...
		TriggerEvent('esx_ambulancejob:reRETROvive', GetPlayerFromServerId(playerPed))
		...
		Citizen.CreateThread(function()	
			...
			ESX.Game.Teleport(playerPed, ConfigMorgue.BornLocation)
			IsMorgued = false
...
-- Create Blips
Citizen.CreateThread(function()
	local blip = AddBlipForCoord(ConfigMorgue.GraveyardBlip.x, ConfigMorgue.GraveyardBlip.y, ConfigMorgue.GraveyardBlip.z)
