...
function BuyAmbulanceMenu()
	...
	SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopInsideAmbulance.Pos)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'ambulance_buy', {
					...
					ESX.TriggerServerCallback('esx_advancedvehicleshop:buyVehicleAJ', function(success)
						if success then
							...
							if vehicleData.model == Config.AmbulanceHeli or vehicleData.model == Config.AmbulanceHeli2 then
								ESX.Game.SpawnVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopOutsideAmbulanceHeli.Pos, Config.ZonesVEHICLESHOP.ShopOutsideAmbulanceHeli.Heading, function(vehicle)
		...
		FreezeEntityPosition(playerPed, false)
		SetEntityVisible(playerPed, true)
		SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopEnteringAmbulance.Pos)
		...
		ESX.Game.SpawnLocalVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideAmbulance.Pos, Config.ZonesVEHICLESHOP.ShopInsideAmbulance.Heading, function(vehicle)
	...
	ESX.Game.SpawnLocalVehicle(firstVehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideAmbulance.Pos, Config.ZonesVEHICLESHOP.ShopInsideAmbulance.Heading, function(vehicle)
		currentDisplayVehicle = vehicle
		TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
		FreezeEntityPosition(vehicle, true)
...
function BuyPoliceMenu()
	...
	FreezeEntityPosition(playerPed, true)
	SetEntityVisible(playerPed, false)
	SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopInsidePolice.Pos)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_buy', {
					...
					ESX.TriggerServerCallback('esx_advancedvehicleshop:buyVehiclePJ', function(success)
						if success then
							...
							if vehicleData.model == Config.PoliceHeli then
								ESX.Game.SpawnVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopOutsidePoliceHeli.Pos, Config.ZonesVEHICLESHOP.ShopOutsidePoliceHeli.Heading, function(vehicle)
									TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
									SetVehicleNumberPlateText(vehicle, generatedPlate)
		...
		FreezeEntityPosition(playerPed, false)
		SetEntityVisible(playerPed, true)
		SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopEnteringPolice.Pos)
		...
		ESX.Game.SpawnLocalVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopInsidePolice.Pos, Config.ZonesVEHICLESHOP.ShopInsidePolice.Heading, function(vehicle)
			currentDisplayVehicle = vehicle
			TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
			FreezeEntityPosition(vehicle, true)
			SetModelAsNoLongerNeeded(vehicleData.model)
	...
	ESX.Game.SpawnLocalVehicle(firstVehicleData.model, Config.ZonesVEHICLESHOP.ShopInsidePolice.Pos, Config.ZonesVEHICLESHOP.ShopInsidePolice.Heading, function(vehicle)
		currentDisplayVehicle = vehicle
		TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
		FreezeEntityPosition(vehicle, true)
		SetModelAsNoLongerNeeded(firstVehicleData.model)
...
function BuyAircraftMenu()
	...
	FreezeEntityPosition(playerPed, true)
	SetEntityVisible(playerPed, false)
	SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopInsideAircraft.Pos)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'aircraft_buy', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_advancedvehicleshop:buyVehicleA', function(success)
					if success then
						...
						ESX.Game.SpawnVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopOutsideAircraft.Pos, Config.ZonesVEHICLESHOP.ShopOutsideAircraft.Heading, function(vehicle)
							TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
							SetVehicleNumberPlateText(vehicle, generatedPlate)
		...
		FreezeEntityPosition(playerPed, false)
		SetEntityVisible(playerPed, true)
		SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopEnteringAircraft.Pos)
		...
		ESX.Game.SpawnLocalVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideAircraft.Pos, Config.ZonesVEHICLESHOP.ShopInsideAircraft.Heading, function(vehicle)
			currentDisplayVehicle = vehicle
			TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
			FreezeEntityPosition(vehicle, true)
			SetModelAsNoLongerNeeded(vehicleData.model)
	...
	ESX.Game.SpawnLocalVehicle(firstVehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideAircraft.Pos, Config.ZonesVEHICLESHOP.ShopInsideAircraft.Heading, function(vehicle)
		currentDisplayVehicle = vehicle
		TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
		FreezeEntityPosition(vehicle, true)
		SetModelAsNoLongerNeeded(firstVehicleData.model)
...
function BuyBoatMenu()
	...
	FreezeEntityPosition(playerPed, true)
	SetEntityVisible(playerPed, false)
	SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopInsideBoat.Pos)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'boat_buy', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_advancedvehicleshop:buyVehicleB', function(success)
					if success then
						...
						ESX.Game.SpawnVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopOutsideBoat.Pos, Config.ZonesVEHICLESHOP.ShopOutsideBoat.Heading, function(vehicle)
							TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
							SetVehicleNumberPlateText(vehicle, generatedPlate)
		...
		FreezeEntityPosition(playerPed, false)
		SetEntityVisible(playerPed, true)
		SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopEnteringBoat.Pos)
		...
		ESX.Game.SpawnLocalVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideBoat.Pos, Config.ZonesVEHICLESHOP.ShopInsideBoat.Heading, function(vehicle)
			currentDisplayVehicle = vehicle
			TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
			FreezeEntityPosition(vehicle, true)
			SetModelAsNoLongerNeeded(vehicleData.model)
	...
	ESX.Game.SpawnLocalVehicle(firstVehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideBoat.Pos, Config.ZonesVEHICLESHOP.ShopInsideBoat.Heading, function(vehicle)
		currentDisplayVehicle = vehicle
		TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
		FreezeEntityPosition(vehicle, true)
		SetModelAsNoLongerNeeded(firstVehicleData.model)
...
function BuyCarMenu()
	...
	FreezeEntityPosition(playerPed, true)
	SetEntityVisible(playerPed, false)
	SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopInsideCar.Pos)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'car_buy', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'car_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_advancedvehicleshop:buyRETROVehicleC', function(success)
					if success then
						IsInMainMenu = false
						menu2.close()
						menu.close()
						...
						ESX.Game.SpawnVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopOutsideCar.Pos, Config.ZonesVEHICLESHOP.ShopOutsideCar.Heading, function(vehicle)
							TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
							SetVehicleNumberPlateText(vehicle, generatedPlate)
		...
		FreezeEntityPosition(playerPed, false)
		SetEntityVisible(playerPed, true)
		SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopEnteringCar.Pos)
		...
		ESX.Game.SpawnLocalVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideCar.Pos, Config.ZonesVEHICLESHOP.ShopInsideCar.Heading, function(vehicle)
			currentDisplayVehicle = vehicle
			TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
			FreezeEntityPosition(vehicle, true)
			SetModelAsNoLongerNeeded(vehicleData.model)
	...
	ESX.Game.SpawnLocalVehicle(firstVehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideCar.Pos, Config.ZonesVEHICLESHOP.ShopInsideCar.Heading, function(vehicle)
		currentDisplayVehicle = vehicle
		TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
		FreezeEntityPosition(vehicle, true)
		SetModelAsNoLongerNeeded(firstVehicleData.model)
...
function BuyTruckMenu()
	...
	FreezeEntityPosition(playerPed, true)
	SetEntityVisible(playerPed, false)
	SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopInsideTruck.Pos)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'truck_buy', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_advancedvehicleshop:buyVehicleT', function(success)
					if success then
						...
						ESX.Game.SpawnVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopOutsideTruck.Pos, Config.ZonesVEHICLESHOP.ShopOutsideTruck.Heading, function(vehicle)
							TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
							SetVehicleNumberPlateText(vehicle, generatedPlate)
		...
		FreezeEntityPosition(playerPed, false)
		SetEntityVisible(playerPed, true)
		SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopEnteringTruck.Pos)
		...
		ESX.Game.SpawnLocalVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideTruck.Pos, Config.ZonesVEHICLESHOP.ShopInsideTruck.Heading, function(vehicle)
			currentDisplayVehicle = vehicle
			TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
			FreezeEntityPosition(vehicle, true)
			SetModelAsNoLongerNeeded(vehicleData.model)
	...
	ESX.Game.SpawnLocalVehicle(firstVehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideTruck.Pos, Config.ZonesVEHICLESHOP.ShopInsideTruck.Heading, function(vehicle)
		currentDisplayVehicle = vehicle
		TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
		FreezeEntityPosition(vehicle, true)
		SetModelAsNoLongerNeeded(firstVehicleData.model)
...
function BuyVIPMenu()
	...
	FreezeEntityPosition(playerPed, true)
	SetEntityVisible(playerPed, false)
	SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopInsideVIP.Pos)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vip_buy', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_advancedvehicleshop:buyVehicleV', function(success)
					if success then
						...
						ESX.Game.SpawnVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopOutsideVIP.Pos, Config.ZonesVEHICLESHOP.ShopOutsideVIP.Heading, function(vehicle)
							TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
							SetVehicleNumberPlateText(vehicle, generatedPlate)
		...
		FreezeEntityPosition(playerPed, false)
		SetEntityVisible(playerPed, true)
		SetEntityCoords(playerPed, Config.ZonesVEHICLESHOP.ShopEnteringVIP.Pos)
		...
		ESX.Game.SpawnLocalVehicle(vehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideVIP.Pos, Config.ZonesVEHICLESHOP.ShopInsideVIP.Heading, function(vehicle)
			currentDisplayVehicle = vehicle
			TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
			FreezeEntityPosition(vehicle, true)
			SetModelAsNoLongerNeeded(vehicleData.model)
	...
	ESX.Game.SpawnLocalVehicle(firstVehicleData.model, Config.ZonesVEHICLESHOP.ShopInsideVIP.Pos, Config.ZonesVEHICLESHOP.ShopInsideVIP.Heading, function(vehicle)
		currentDisplayVehicle = vehicle
		TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
		FreezeEntityPosition(vehicle, true)
		SetModelAsNoLongerNeeded(firstVehicleData.model)
...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in pairs(Config.ZonesVEHICLESHOP) do
