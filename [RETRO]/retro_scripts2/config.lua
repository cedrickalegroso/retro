...
Config.Room = {
	vector3(-444.13088989258,-309.98211669922,34.910572052002),
  ...
  vector3(-444.73071289062,6010.66015625,31.716394424438), --PD
...
Config.ZonesDUTY = {
	...
	PoliceDuty = {
	  ...
	  AmbulanceDuty = {
		Pos = { x =  -508.08673095703, y = -311.76034545898, z = 41.620709228516 },
	  ...
	  GrooveDuty = {
		Pos = { x =  -92.904975891113, y = -1793.5168457031, z = 31.195140838623 },
		Size = { x = 2.5, y = 2.5, z = 1.5 },
		Color = { r = 0, g = 255, b = 0 },
		Type = 27,
		job = 'groove'
