...
AddEventHandler('nk_repair:MettiCrick', function(ped, coords, veh)
    ...
    --exports['progressBars']:startUI(11000, "AGGIUSTANDO IL VEICOLO") -- TRANSLATE THIS - THAT SAY WHEN YOU REPAIR THE 
  
    TriggerEvent("mythic_progbar:client:progress", {
        name = "unique_action_name",
        duration = 11000,
        label = "Adjusting Vehicle",
        useWhileDead = false,
        canCancel = true,
        controlDisables = {
            disableMovement = true,
