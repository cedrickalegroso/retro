local dropkey 	= 246 -- change this number based on the key you want to use to drop the item 
...
attachPropList = {
	...
	["ferramentas"] = { 
        ["model"] = "prop_tool_box_04", ["bone"] = 28422, ["x"] = 0.062,["y"] = 0.02,["z"] = 0.0,["xR"] = 0.0,["yR"] = 0.0, ["zR"] = 0.0 
    },
