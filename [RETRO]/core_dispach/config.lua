...
OpenMenuKey = 'F4', -- Key to open the dispach menu (Leave blank if you dont need a key)
...
JobThree = {job = 'groove', canRequestLocalBackup = true, canRequestOtherJobBackup = true, forwardCall = true, canRemoveCall = true, callCommand = "202", color = "grayunit", label = "Mech",  blipColor = 39 },
