Config.Jobs.slaughterer = {
	...
	Zones = {
		...
		CloakRoom = { ---57.95629119873,6270.560546875,31.392694473267
		--	Pos = {x = -1071.13, y = -2003.78, z = 14.78},
		   Pos = {x = -57.95629119873, y = 6270.560546875, z = 30.392694473267},
		...
		Delivery = { -- 94.226318359375,6356.3203125,31.375862121582
		--	Pos = {x = -596.15, y = -889.32, z = 24.50},
		Pos = {x = 94.226318359375, y = 6356.3203125, z = 30.37586212158},
			Color = {r = 204, g = 204, b = 0},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Marker = 1,
			Blip = true,
