...
local dcname = "Nefarious City RP Attendance" -- bot's name
local http = "https://discordapp.com/api/webhooks/745149718815965325/jS2KlItDrTfQP-5x3agH-mrQIh6Y-e2TkSTL5fSnbcPUE18LX7Bmshi6IBJEsioHiHWr" -- webhook for police
local http2 = "https://discordapp.com/api/webhooks/745149790119264327/pCtTowWjk8pacIWE4uXlopMkEio9O6Fd-iJmP95u9DHpe7p2yXO_jB-7Ke18m8YcwUAa" -- webhook for ems (you can add as many as you want)
