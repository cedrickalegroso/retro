...
AddEventHandler('esx_lscustom:buyMod', function(price)
	...
	if Config.IsMechanicJobOnly then
		...
		if price < societyAccount.money then
			...
			local message = name..' bought a mod for '..price
			local color = 56108
			local webhook = 'https://discordapp.com/api/webhooks/770102357949939723/xp4xg6hsjar29Hi2waH10kMVf_J5pIxsPsOeUHPO-K--gqgFVSlF8pb7BLgkKWnf2BLA'
