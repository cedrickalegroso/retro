...
RegisterServerEvent('esx_mechanicjob:checkFixtool')
AddEventHandler('esx_mechanicjob:checkFixtool', function()
	...
	if FixToolQuantity <= 0 then
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = 'You dont have any Repair tool' })
	end 
...
RegisterServerEvent('esx_mechanicjob:checkFixtool2')
AddEventHandler('esx_mechanicjob:checkFixtool2', function()
	...
	if FixToolQuantity > 0 then
		...
		TriggerClientEvent('esx_mechanicjob:carfix', source)
	end 
...
RegisterServerEvent('esx_mechanicjob:starRETROtCraft')
AddEventHandler('esx_mechanicjob:starRETROtCraft', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starRETROtCraft2')
AddEventHandler('esx_mechanicjob:starRETROtCraft2', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starRETROtCraft3')
AddEventHandler('esx_mechanicjob:starRETROtCraft3', function()
	local _source = source
