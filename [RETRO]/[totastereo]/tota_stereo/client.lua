...
RegisterCommand("stereo", function(source, args, rawCommand)
    ...
    if IsPedInAnyVehicle(PlayerPedId(), false) then
        ...
        TriggerEvent('chatMessage', "[TOTA STEREO]", {79, 247, 158}, " Stereo on!")
        print("Nueva canción")
    else
        playing = false
        TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 47, 58}, " You're not in a car!")
    end
end, false)
...
RegisterCommand("parar", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 247, 158}, " Stereo off!")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v10", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 10 (MAX)")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, "  There's no song playing")
end
end)
...
RegisterCommand("v9", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 9")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v8", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 8")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v7", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 7")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v6", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 6")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v5", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 5")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v4", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 4")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v3", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 3")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v2", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 2")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
...
RegisterCommand("v1", function(source, args, rawCommand)
    ...
    TriggerEvent('chatMessage', "[TOTA STEREO]", {150, 76, 238}, " Volume 1 (MIN)")
else
    TriggerEvent('chatMessage', "[TOTA STEREO]", {255, 100, 100}, " There's no song playing")
end
end)
