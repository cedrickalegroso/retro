...
ESX.RegisterUsableItem('powiekszonymagazynekPD', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)	
    TriggerClientEvent('esx_attachments_bleiker:powiekszonymagazynekPD', source)
...
ESX.RegisterUsableItem('kompensatorPD', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)	
    TriggerClientEvent('esx_attachments_bleiker:kompensatorPD', source)
...
ESX.RegisterUsableItem('SuppressorPD', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)	
    TriggerClientEvent('esx_attachments_bleiker:SuppressorPD', source)
