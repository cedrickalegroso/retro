...
Config.ZonesVEHICLESHOP = {
	...
	ShopEnteringAmbulance = {  ---263.08251953125,6320.2749023438,32.427276611328
		-- Pos    = vector3(-436.9846496582,-316.04748535156,33.910766601562),
		Pos    = vector3(339.17071533203,-589.04437255859,42.584091949463),
	...
	Pos     = vector3(312.90603637695,-575.08703613281,94.479934692383),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 320.14,
		Type    = -1,
		ShopId  = 1
...
Pos     = vector3(322.76651000977,-587.90881347656,28.796844482422),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 318.34,
		Type    = -1,
		ShopId  = 1
	...
	-- Car Shop
	ShopEnteringCar = {
		Pos    = vector3(-34.033946990967,-1101.5812988281,25.422355651855),
	...
	ShopInsideCar = {
		Pos     = vector3(-44.430221557617,-1096.3961181641,26.422334671021),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 234.82,
		Type    = -1,
		ShopId  = 5
	...
	ShopOutsideCar = {
		Pos     = vector3(-26.152908325195,-1082.9404296875,26.61107635498),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 199.59,
		Type    = -1,
		ShopId  = 5
