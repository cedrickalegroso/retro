...
RegisterServerEvent('esx_policejob:haRETROndcuff')
AddEventHandler('esx_policejob:haRETROndcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'police' then
		TriggerClientEvent('esx_policejob:haRETROndcuff', target)
	else
