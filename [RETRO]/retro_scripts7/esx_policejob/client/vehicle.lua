...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			local shopElements = {}
			local shopCoords = ConfigPOPO.PoliceStations[station][part][partNum].InsideShop
			local authorizedVehicles = ConfigPOPO.AuthorizedVehicles[type][ESX.PlayerData.job.grade_name]
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = ConfigPOPO.PoliceStations[station][part][partNum].SpawnPoints
