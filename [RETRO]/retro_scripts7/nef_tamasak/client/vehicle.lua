...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			local shopElements = {}
			local shopCoords = ConfigTAMASAK.TamasakStations[station][part][partNum].InsideShop
			local authorizedVehicles = ConfigTAMASAK.AuthorizedVehicles[type][ESX.PlayerData.job.grade_name]
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('nef_tamasakv2:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = ConfigTAMASAK.TamasakStations[station][part][partNum].SpawnPoints
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('nef_tamasakv2:buyJobVehicle', function (bought)
					if bought then
