...
Config = {  
  ...
  UsingESXLimits = true, -- true if using ESX inventory item limits 
  ...
  Motels = {
    ...
    Bilingsgate = {
      ...
      BlipScale   = 0.8,
      BlipDisplay = 3,
      BlipText    = "Motel La puerta de Bill",
