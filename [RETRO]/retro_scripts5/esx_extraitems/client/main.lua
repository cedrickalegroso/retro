...
RegisterNetEvent('esx_extraitems:weedaddarmor')
AddEventHandler('esx_extraitems:weedaddarmor', function(source)
	
	if GetPedArmour(GetPlayerPed(-1)) == 40 or GetPedArmour(GetPlayerPed(-1)) == 50 then
		ESX.ShowNotification("You already have full armor")
	  else
		ESX.ShowNotification("You gained 20% armor")
