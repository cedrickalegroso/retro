Locales['en'] = {
	...
	['must_police'] = 'Must be Police Job to Access this!',
		-- Vermilllio
		['blip_vermillion_garage'] = 'Garage | Vermillion Garage',
		['blip_vermillion_pound'] = 'Garage | Vermillion Pound',
		['garage_vermillion'] = 'Vermillion Garage',
		['pound_vermillion'] = 'Vermillion Pound: Fee $%s',
		['garage_no_vermillion'] = 'You dont own any Vermillion Vehicles!',
		['garage_no_vermillion_aircraft'] = 'You dont own any Vermillion Aircrafts!',
		...
		['must_vermillion'] = 'Must be Vermillion Job to Access this!',
			...
			['garage_cuatro'] = 'Cuatro Garage',
			['pound_cuatro'] = 'Cuatro Pound: Fee $%s',
			['garage_no_cuatro'] = 'You dont own any Cuatro Vehicles!',
			['garage_no_cuatro_aircraft'] = 'You dont own any Cuatro Aircrafts!',
			['cuatro_is_impounded'] = 'Your Cuatro Vehicle is not here.',
			['must_cuatro'] = 'Must be Cuatro Job to Access this!',
	-- Mechanic
