...
RegisterServerEvent('esx_jobChat:911Silent')
...
RegisterServerEvent('esx_jobChat:911truck')
AddEventHandler('esx_jobChat:911truck', function(targetCoords, msg, streetName, emergency)
    local _source = source
	local xPlayer = ESX.GetPlayerFromId(source)
	fal = xPlayer.getName(source)
	local messageFull
