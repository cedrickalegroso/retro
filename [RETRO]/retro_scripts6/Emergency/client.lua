...
RegisterCommand('911DRUGSELL', function(source, args, rawCommand)
	--TriggerEvent("chatMessage"," [911] " , {26, 83, 255},   "A notice has been sent to the Authorities" )
    ...
    local playerCoords = GetEntityCoords(PlayerPedId())
        ...
        streetName = GetStreetNameFromHashKey(streetName)
	local msg = rawCommand:sub(4)
	local emergency = '911Silent'
    TriggerServerEvent('esx_jobChat:911Silent',{
        x = ESX.Math.Round(playerCoords.x, 1),
        y = ESX.Math.Round(playerCoords.y, 1),
        z = ESX.Math.Round(playerCoords.z, 1)
    }, msg, streetName, emergency)
...
RegisterCommand('911truck', function(source, args, rawCommand)
	--TriggerEvent("chatMessage"," [911] " , {26, 83, 255},   "A notice has been sent to the Authorities" )
    ...
    local playerCoords = GetEntityCoords(PlayerPedId())
        ...
        streetName = GetStreetNameFromHashKey(streetName)
	local msg = rawCommand:sub(4)
	local emergency = '911truck'
    TriggerServerEvent('esx_jobChat:911truck',{
        x = ESX.Math.Round(playerCoords.x, 1),
        y = ESX.Math.Round(playerCoords.y, 1),
        z = ESX.Math.Round(playerCoords.z, 1)
    }, msg, streetName, emergency)
...
RegisterCommand('911VANLOCK', function(source, args, rawCommand)
	--TriggerEvent("chatMessage"," [911] " , {26, 83, 255},   "A notice has been sent to the Authorities" )
