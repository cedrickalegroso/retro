...
MFS.SqlSaveTime = 2.0
MFS.MenuKey = "M"
MFS.OpenWithHotkey = false  -- open with openSkelly command if choosing not to use hotkey.
MFS.UsingStress    = true   -- disables head damage timecycle modifier if using MF_Stress.
...
MFS.UIPositions = 
{   
    ["Body"]      = vector2(0.2820, 0.3051),
    ["Head"]      = vector2(0.4050, 0.2240),
    ["LeftArm"]   = vector2(0.4610, 0.4044),
    ["LeftLeg"]   = vector2(0.4195, 0.5320),
    ["RightArm"]  = vector2(0.2680, 0.4043),
    ["RightLeg"]  = vector2(0.2870, 0.5320), 
