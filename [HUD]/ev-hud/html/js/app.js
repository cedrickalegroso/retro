...
(() => {
    ...
    EVHud.ToggleSeatbelt = function(data) {
        if (data.seatbelt) {
    ...
    EVHud.ToggleHarness = function(data) {
        if (data.toggle) {
    ...
    EVHud.UpdateProximity = function(data) {
        if (data.prox == 1) {
    ...
    EVHud.UpdateCompass = function(data) {
    ...
    EVHud.UpdateMeters = function(data) {
        ...
        window.addEventListener('message', function(event) {
            switch (event.data.action) {
                ...
                case "close":
                    ...
                    break;
                case "update":
                    EVHud.Update(event.data);
                    break;
                case "show":
                    EVHud.Show(event.data);
                    break;
                case "hudtick":
                    EVHud.UpdateHud(event.data);
                    break;
                case "car":
                    EVHud.CarHud(event.data);
                    break;
                case "seatbelt":
                    EVHud.ToggleSeatbelt(event.data);
                    break;
                case "harness":
                    EVHud.ToggleHarness(event.data);
                    break;
                case "proximity":
                    EVHud.UpdateProximity(event.data);
                    break;
                case "talking":
                    EVHud.SetTalkingState(event.data);
                    break;
                case "UpdateCompass":
                    EVHud.UpdateCompass(event.data);
                    break;
                case "UpdateDrivingMeters":
                    EVHud.UpdateMeters(event.data);
                    break;
