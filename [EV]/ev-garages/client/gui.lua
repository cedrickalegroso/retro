...
function Menu.addButton(name, func,args,extra,damages,bodydamages,funcmostrar)
	...
	Menu.GUI[Menu.buttonCount+1]["funcmostrar"] = funcmostrar
...
function Menu.updateSelection() 
	if IsControlJustPressed(1, Keys["DOWN"]) then 
		...
		if Menu.GUI[Menu.selection +1]["funcmostrar"] then
			MenuCallFunction(Menu.GUI[Menu.selection +1]["funcmostrar"], Menu.GUI[Menu.selection +1]["args"])
		end
