...
function pagorecupero(data)
    ESX.TriggerServerCallback('betrayed_garage:checkMoney', function(hasEnoughMoney)
        ...
        elseif hasEnoughMoney == "deudas" then
            recuperar()
            exports['mythic_notify']:SendAlert('error', 'You have a debt with the government greater than $2000, you will not be able to recover your vehicle until you pay your fines!')
        else
            recuperar()
