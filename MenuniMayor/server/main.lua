...
ESX.RegisterServerCallback('esx_menu:Bill_getBills', function(source, cb)
...
ESX.RegisterServerCallback('esx_menu:Admin_getUsergroup', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
-- Weapon Menu --
RegisterServerEvent('esx_menu:Weapon_AmmoToPedS')
AddEventHandler('esx_menu:Weapon_AmmoToPedS', function(plyId, value, quantity)
	TriggerClientEvent('esx_menu:Weapon_AmmoToPedC', plyId, value, quantity)
end)

-- Admin Menu --
RegisterServerEvent('esx_menu:Admin_teleS')
AddEventHandler('esx_menu:Admin_teleS', function(plyId, plyPedCoords)
    ...
    if grade.group == 'mod' or grade.group == 'admin' or grade.group == 'superadmin' then
		TriggerClientEvent('esx_menu:Admin_teleC', plyId, plyPedCoords)
	else
...
-- Grade Menu --
RegisterServerEvent('esx_menu:Patron_promouvoirplayer')
AddEventHandler('esx_menu:Patron_promouvoirplayer', function(target)
...
RegisterServerEvent('esx_menu:Patron_destituerplayer')
AddEventHandler('esx_menu:Patron_destituerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('esx_menu:Patron_recruterplayer')
AddEventHandler('esx_menu:Patron_recruterplayer', function(target, job, grade)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('esx_menu:Patron_virerplayer')
AddEventHandler('esx_menu:Patron_virerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('esx_menu:Patron_promouvoirplayer2')
AddEventHandler('esx_menu:Patron_promouvoirplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('esx_menu:Patron_destituerplayer2')
AddEventHandler('esx_menu:Patron_destituerplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('esx_menu:Patron_recruterplayer2')
AddEventHandler('esx_menu:Patron_recruterplayer2', function(target, job2, grade2)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('esx_menu:Patron_virerplayer2')
AddEventHandler('esx_menu:Patron_virerplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
