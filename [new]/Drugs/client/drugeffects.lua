...
AddEventHandler("esx_drugs:activate_meth",function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		...
		exports['taskbar']:taskBar(10000, "SMOKING METH")
		Citizen.Wait(10000)
...
AddEventHandler("esx_drugs:activate_weed",function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "WORLD_HUMAN_SMOKING_POT", 0, true)
		exports['taskbar']:taskBar(10000, "SMOKING JOINT")
		Citizen.Wait(10000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(10000, "SMOKING JOINT")
...
AddEventHandler("esx_drugs:activate_coke",function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "WORLD_HUMAN_SMOKING_POT", 0, true)
		exports['taskbar']:taskBar(10000, "SMOKING CRACK COCAINE")
		Citizen.Wait(10000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(10000, "SMOKING CRACK COCAINE")
...
AddEventHandler("esx_newDrugs:UsableItem",function()
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		...
		exports['taskbar']:taskBar(8000, "CONNECTING")
		Citizen.Wait(8000)
	else
		exports['taskbar']:taskBar(8000, "CONNECTING")
		Citizen.Wait(8000)
