...
AddEventHandler("BrickToCoke10g", function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		...
		exports['taskbar']:taskBar(15000, "COKE BRICK  >  COKE (10G)")
		Citizen.Wait(15000)
...
AddEventHandler("BrickToMeth10g", function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true)
		exports['taskbar']:taskBar(15000, "METH BRICK  >  METH (10G)")
		Citizen.Wait(15000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(15000, "METH BRICK  >  METH (10G)")
...
AddEventHandler("BrickToWeed20g", function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true)
		exports['taskbar']:taskBar(15000, "WEED BRICK  >  WEED (20G)")
		Citizen.Wait(15000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(15000, "WEED BRICK  >  WEED (20G)")
...
AddEventHandler("Coke10gToCoke1g", function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true)
		exports['taskbar']:taskBar(15000, "COKE (10G)  >  COKE (1G)")
		Citizen.Wait(15000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(15000, "COKE (10G)  >  COKE (1G)")
...
AddEventHandler("Meth10gToMeth1g", function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true)
		exports['taskbar']:taskBar(15000, "METH (10G)  >  METH (1G)")
		Citizen.Wait(15000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(15000, "METH (10G)  >  METH (1G)")
...
AddEventHandler("Weed20gToWeed4g", function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true)
		exports['taskbar']:taskBar(15000, "WEED (20G)  >  WEED (4G)")
		Citizen.Wait(15000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(15000, "WEED (20G)  >  WEED (4G)")
...
AddEventHandler("Weed4gToJoint2g", function()
	...
	if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
		TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_BUM_BIN", 0, true)
		exports['taskbar']:taskBar(15000, "WEED (4G)  >  JOINT (2G)")
		Citizen.Wait(15000)
		ClearPedTasks(PlayerPedId())
	else
		exports['taskbar']:taskBar(15000, "WEED (4G)  >  JOINT (2G)")
